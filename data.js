...
/* ============================================================
   ...
   Ajoute une ligne par étape, dans l'ordre chronologique.
   icon = un emoji, date = texte libre ("Mai 2026", "13 juin 2026"...)
   ============================================================ */
window.TIMELINE_DATA = [
  ...
  // TODO : ajoute ici la rencontre, le "premier ami", le premier
  // "je t'aime", ou tout autre moment important, dans l'ordre :
  // { date: "...", icon: "✨", title: "La rencontre", description: "..." },
  // { date: "...", icon: "😳", title: "Premier je t'aime", description: "..." },
];
